...
# Plot
interactive_plot(time_series_ALAinIslamicIns, station = "Al Ain Islamic Ins", group =   pollutant, pollu="WindSpeed")
interactive_plot(time_series_ALAinStreet, station = "Al Ain Street", group = pollutant, pollu="WindSpeed")
interactive_plot(time_series_AlMafraq, station = "Al Mafraq", group = pollutant, pollu="WindSpeed")
interactive_plot(time_series_AlQua0x27a, station = "Al Qua'a", group = pollutant, pollu="WindSpeed")
interactive_plot(time_series_AlRuwais, station = "Al Ruwais", group = pollutant, pollu="WindSpeed")
interactive_plot(time_series_AlTawia, station = "Al Tawia", group = pollutant, pollu="WindSpeed")
interactive_plot(time_series_BainAljesrain, station = "Bain Al Jesrain", group = pollutant, pollu="WindSpeed")
interactive_plot(time_series_baniyasSchool, station = "Baniyas School", group = pollutant, pollu="WindSpeed")
interactive_plot(time_series_BidaZayed, station = "Bida Zayed", group = pollutant, pollu="WindSpeed")
interactive_plot(time_series_E11Road, station = "E11 Road", group = pollutant, pollu="WindSpeed")
interactive_plot(time_series_GayathiSchool, station = "Gayathi School", group = pollutant, pollu="WindSpeed")
interactive_plot(time_series_Habshan, station = "Habshan", group = pollutant, pollu="WindSpeed")
interactive_plot(time_series_HamdanStreet, station = "Hamdan Street", group = pollutant, pollu="WindSpeed")
interactive_plot(time_series_KhadejaPrimarySchool, station = "Khadeja Primary School", group = pollutant, pollu="WindSpeed")
interactive_plot(time_series_KhalifaCityA, station = "Khalifa City A", group = pollutant, pollu="WindSpeed")
interactive_plot(time_series_KhalifaHighSchool, station = "Khalifa High School", group =pollutant, pollu="WindSpeed")
interactive_plot(time_series_LiwaOasis, station = "Liwa Oasis", group = pollutant, pollu="WindSpeed")
interactive_plot(time_series_Mussafah, station = "Mussafah", group = pollutant, pollu="WindSpeed")
interactive_plot(time_series_Sweihan, station = "Sweihan", group = pollutant, pollu="WindSpeed")
interactive_plot(time_series_Zakher, station = "Zakher", group = pollutant, pollu="WindSpeed")
...
coord_site <- get_sites(var = "WindSpeed")
