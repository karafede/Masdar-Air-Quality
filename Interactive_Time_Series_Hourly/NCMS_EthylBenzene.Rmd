...
---
title: "**EthylBenzene from National Center of Meteorology & Seismology (NCMS) stations in the UAE**"
output:
  html_document:
    fig_height: 2.5
    fig_width: 9.5
...
# Plot
interactive_plot(time_series_AlQurayaastation, station = "Al Qurayaa station", group = pollutant, pollu="EthylBenzene")
