...
library(rmarkdown)
 ...
 EAD_2013 <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/database_EAD data 2013_hourly.csv")
 EAD_2014 <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/database_EAD data 2014_hourly.csv")
 EAD_2015 <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/database_EAD data 2015_hourly.csv")
 EAD_2016 <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/database_EAD data 2016_hourly.csv")
 EAD_2017 <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/database_EAD data 2017_hourly.csv")
 
 EAD_2013_filtered <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/Filtered_4_Box/database_EAD_ 2013 _hourly_filtered.csv")
 EAD_2014_filtered <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/Filtered_4_Box/database_EAD_ 2014 _hourly_filtered.csv")
 EAD_2015_filtered <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/Filtered_4_Box/database_EAD_ 2015 _hourly_filtered.csv")
 EAD_2016_filtered <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/Filtered_4_Box/database_EAD_ 2016 _hourly_filtered.csv")
 EAD_2017_filtered <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/Filtered_4_Box/database_EAD_ 2017 _hourly_filtered.csv")
