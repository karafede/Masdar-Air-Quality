...
NCMS_2013 <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/database_NCMS data 2013_hourly.csv")
NCMS_2014 <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/database_NCMS data 2014_hourly.csv")
NCMS_2015 <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/database_NCMS Data 2015_hourly.csv")
NCMS_2016 <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/database_NCMS data 2016_hourly.csv")
NCMS_2017 <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/database_NCMS data 2017_hourly.csv")

NCMS <- rbind(NCMS_2013 ,NCMS_2014, NCMS_2015, NCMS_2016, NCMS_2017)

NCMS_2013_filtered <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/Filtered_4_Box/database_NCMS_ 2013 _hourly_filtered.csv")
NCMS_2014_filtered <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/Filtered_4_Box/database_NCMS_ 2014 _hourly_filtered.csv")
NCMS_2015_filtered <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/Filtered_4_Box/database_NCMS_ 2015 _hourly_filtered.csv")
NCMS_2016_filtered <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/Filtered_4_Box/database_NCMS_ 2016 _hourly_filtered.csv")
NCMS_2017_filtered <- read_csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQ_TIDY_Data/OUTPUT_DB_Data/Filtered_4_Box/database_NCMS_ 2017 _hourly_filtered.csv")
