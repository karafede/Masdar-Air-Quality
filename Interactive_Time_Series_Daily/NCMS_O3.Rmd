...
interactive_plot(time_series_Wasit, station = "Wasit", group = pollutant, pollu="O3")
interactive_plot(time_series_AlQurayaastation, station = "Al Qurayaa station", group = pollutant, pollu="O3")
interactive_plot(time_series_FujjairahCityCenter, station = "Fujjairah City Center", group = pollutant, pollu="O3")
```
