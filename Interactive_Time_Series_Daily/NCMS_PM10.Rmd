...
interactive_plot(time_series_Wasit, station = "Wasit", group = pollutant, pollu="PM10")
interactive_plot(time_series_AlQurayaastation, station = "Al Qurayaa station", group = pollutant, pollu="PM10")
```
