...
for (aa in list_year){
  ...
  year_s<-2013 + xx
  file_name_out <- paste("filtered_3_5_box/database_NCMS_", year_s, "_outliers.csv")
...
for (aa in list_year){
  ...
  year_s<-2013 + xx
  file_name_out <- paste("filtered_4_box/database_NCMS_", year_s, "_outliers.csv")
...
for (aa in list_year){
  ...
  year_s<-2013 + xx
  file_name_out <- paste("filtered_3_5_box/database_DM_", year_s, "_outliers.csv")
...
for (aa in list_year){
  ...
  year_s<-2013 + xx
  file_name_out <- paste("filtered_4_box/database_DM_", year_s, "_outliers.csv")
...
# FEED ONLY ONE YEAR HOURLY DATA OF STATIONS FROM THE SAME AUTHORITY for example 2013 data from the Dubai Municipality (DM)
DM_2013 <- read_csv('Z:/_SHARED_FOLDERS/Air Quality/Phase 1/Pathflow of Phase I_DG/dawit Data/Hourly Database format CSV/Arranged dates/database_EAD_2013_hourly.csv')
DM_2014 <- read_csv('Z:/_SHARED_FOLDERS/Air Quality/Phase 1/Pathflow of Phase I_DG/dawit Data/Hourly Database format CSV/Arranged dates/database_EAD_2014_hourly.csv')
DM_2015 <- read_csv('Z:/_SHARED_FOLDERS/Air Quality/Phase 1/Pathflow of Phase I_DG/dawit Data/Hourly Database format CSV/Arranged dates/database_EAD_2015_hourly.csv')
DM_2016 <- read_csv('Z:/_SHARED_FOLDERS/Air Quality/Phase 1/Pathflow of Phase I_DG/dawit Data/Hourly Database format CSV/Arranged dates/database_EAD_2016_hourly.csv')
#DM_2014 <- read.csv('D:/database_DM_2014_hourly.csv')
#DM_2015 <- read.csv('D:/database_DM_2015_hourly.csv')
#DM_2016 <- read.csv('D:/database_DM_2016_hourly.csv')
...
for (aa in list_year){
  ...
  year_s<-2013 + xx
  file_name_out <- paste("filtered_3_5_box/database_EAD_", year_s, "_outliers.csv")
...
for (aa in list_year){
  ...
  year_s<-2013 + xx
  file_name_out <- paste("filtered_4_box/database_EAD_", year_s, "_outliers.csv")
