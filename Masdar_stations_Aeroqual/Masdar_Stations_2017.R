...
setwd("Z:/_SHARED_FOLDERS/Air Quality/Phase 1/In situ data/5_minute_Masdar_Stations/fieldstation_Oct_2017")
...
write.csv(All_data, "field_station_Masdar_18_Oct_2017.csv")
