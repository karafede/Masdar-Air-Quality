...
david_resutl<-O3_daily_8hourly(NCMS_2017, 2017 )
NCMS_2017_8hour<- as.data.frame(david_resutl[1])
NCMS_2017_daily<- as.data.frame(david_resutl[2])
write_csv(NCMS_2017_8hour, "8Hour_O3/database_NCMS_2017_O3_8hour.csv", na = "NA")
write_csv(NCMS_2017_daily, "Daily_O3/database_NCMS_2017_O3_daily.csv", na = "NA")
...
david_resutl<-O3_daily_8hourly(DM_2017, 2017 )
DM_2017_8hour<- as.data.frame(david_resutl[1])
DM_2017_daily<- as.data.frame(david_resutl[2])
write_csv(DM_2017_8hour, "8Hour_O3/database_DM_2017_O3_8hour.csv", na = "NA")
write_csv(DM_2017_daily, "Daily_O3/database_DM_2017_O3_daily.csv", na = "NA")
...
david_resutl<-O3_daily_8hourly(EAD_2017, 2017 )
EAD_2017_8hour<- as.data.frame(david_resutl[1])
EAD_2017_daily<- as.data.frame(david_resutl[2])
write_csv(EAD_2017_8hour, "8Hour_O3/database_EAD_2017_O3_8hour.csv", na = "NA")
write_csv(EAD_2017_daily, "Daily_O3/database_EAD_2017_O3_daily.csv", na = "NA")
